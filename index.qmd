...
map = {
  ...
  points.selectAll("image")
    ...
    .style("opacity", 1)
    .on("click", function (d) { 
      if (d.google_maps) window.open(d.google_maps, '_blank');
    })
    .on("mouseover", function (d) { 
      let tooltipText = "<b>" + d.plaza + "</b><br><i>Haz clic para abrir la ubicación en Google Maps</i>";
